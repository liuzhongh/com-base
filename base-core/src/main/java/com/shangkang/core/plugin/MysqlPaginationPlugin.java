...
/**
 * Created by liuzh on 16-4-26.
 */
@Intercepts({ @Signature(type = Executor.class, method = "query", args = {
        MappedStatement.class, Object.class, RowBounds.class,
        ResultHandler.class }) })
public class MysqlPaginationPlugin implements Interceptor {
                                            ...
                                            Object parameterObject, Pagination pagination) throws Throwable
    {
        ...
        String newSql = getLimitString(context.getSql(), start, pagination.getPageSize());
        SqlSource sqlSource = sqlSourceParser.parse(newSql, parameterType, context.getBindings());
        return sqlSource;
    }
    ...
    private String getLimitString(String sql, int offset, int limit)
    {
        ...
        finalSql.append(sql).append(" limit ").append(offset)
                .append(", ").append(limit);
